...
export const FILE_SIZE_EXCEEDS_LIMIT_ALLOWED = 'FILE_SIZE_EXCEEDS_LIMIT_ALLOWED';
export const NUMBER_OF_FILES_EXCEED_LIMIT_ALLOWED = 'NUMBER_OF_FILES_EXCEED_LIMIT_ALLOWED';
...
const FileValidation: TFileErrorCode = {
  ...
  LIMIT_UNEXPECTED_FILE: createErrorCode(
    121003, 
    'Limit unexpected file'
  ),
  LIMIT_PART_COUNT: createErrorCode(
    121004, 
    'Limit part count'
  ),
  LIMIT_FIELD_KEY: createErrorCode(
    121005, 
    'Limit field key'
  ),
  LIMIT_FIELD_COUNT: createErrorCode(
    121006, 
    'Limit field count'
  ),
  LIMIT_FIELD_VALUE: createErrorCode(
    121007, 
    'Limit field value'
  ),
  MULTER_ERROR: createErrorCode(
    121008, 
    'Multer error'
  ),
