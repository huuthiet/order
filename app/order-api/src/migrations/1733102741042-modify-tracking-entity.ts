...
export class ModifyTrackingEntity1733102741042 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_0fec0873c97f173319b38957bf\` ON \`order_tbl\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_0fec0873c97f173319b38957bf\` ON \`order_tbl\` (\`invoice_column\`)`);
    }
