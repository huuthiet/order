...
export class AddPromotionEntity1738742807413 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`promotion_tbl\` ADD CONSTRAINT \`FK_efb267e51c2c80767e04e17773c\` FOREIGN KEY (\`branch_column\`) REFERENCES \`branch_tbl\`(\`id_column\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`promotion_tbl\` DROP FOREIGN KEY \`FK_efb267e51c2c80767e04e17773c\``);
