...
export const ORDER_ITEM_NOT_BELONG_TO_ANY_ORDER = 'ORDER_ITEM_NOT_BELONG_TO_ANY_ORDER';
export const REQUEST_ORDER_ITEM_GREATER_ORDER_ITEM_QUANTITY = 'REQUEST_ORDER_ITEM_GREATER_ORDER_ITEM_QUANTITY';
export const ALL_ORDER_ITEM_MUST_BELONG_TO_A_ORDER = 'ALL_ORDER_ITEM_MUST_BELONG_TO_A_ORDER';
...
export type TOrderItemErrorCode = Record<TOrderItemErrorCodeKey, TErrorCodeValue>;

export const OrderItemValidation: TOrderItemErrorCode = {
  ORDER_ITEM_NOT_FOUND: createErrorCode(1031, 'Order item not found'),
  ORDER_ITEM_NOT_BELONG_TO_ANY_ORDER: createErrorCode(1032, 'Order item not belong to any order'),
