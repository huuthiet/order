...
export const ERROR_WHEN_GET_MENU_ITEM_BY_PROMOTION = 'ERROR_WHEN_GET_MENU_ITEM_BY_PROMOTION';
export const ERROR_WHEN_UPDATE_PROMOTION = 'ERROR_WHEN_UPDATE_PROMOTION';
export const PROMOTION_ALREADY_APPLIED_CAN_NOT_UPDATE_BRANCH = 'PROMOTION_ALREADY_APPLIED_CAN_NOT_UPDATE_BRANCH';
export const PROMOTION_ALREADY_APPLIED_CAN_NOT_UPDATE_TIME = 'PROMOTION_ALREADY_APPLIED_CAN_NOT_UPDATE_TIME';
export const UPDATE_END_TIME_MUST_BE_GREATER_TODAY = 'UPDATE_END_TIME_MUST_BE_GREATER_TODAY';
export const PROMOTION_ALREADY_EXPIRED_CAN_NOT_UPDATE_TIME = 'PROMOTION_ALREADY_EXPIRED_CAN_NOT_UPDATE_TIME';
export const END_TIME_MUST_BE_GREATER_OR_EQUAL_START_TIME = 'END_TIME_MUST_BE_GREATER_OR_EQUAL_START_TIME';
export const END_TIME_MUST_BE_GREATER_OR_EQUAL_TODAY = 'END_TIME_MUST_BE_GREATER_OR_EQUAL_TODAY';
export const PROMOTION_ALREADY_APPLIED_CAN_NOT_UPDATE_START_TIME = 'PROMOTION_ALREADY_APPLIED_CAN_NOT_UPDATE_START_TIME';
export const PROMOTION_ALREADY_APPLIED_CAN_NOT_DELETE = 'PROMOTION_ALREADY_APPLIED_CAN_NOT_DELETE';
