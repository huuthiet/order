...
export const START_DATE_ONLY_SMALLER_OR_EQUAL_END_DATE = 'START_DATE_ONLY_SMALLER_OR_EQUAL_END_DATE';
...
export const RevenueValidation: TRevenueErrorCode = {
  ...
  START_DATE_IS_NOT_EMPTY: createErrorCode(
    143205, 
    'Start date is not empty'
  ),
  END_DATE_IS_NOT_EMPTY: createErrorCode(
    143206, 
  ...
  UPDATE_REVENUE_ERROR: createErrorCode(
    143208, 
