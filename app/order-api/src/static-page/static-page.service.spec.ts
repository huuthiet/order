...
describe('StaticPageService', () => {
  ...
  describe('update', () => {
    ...
    it('should throw exception if service.validateUpdatedKey throws', async () => {
      ...
      jest
        .spyOn(service, 'validateUpdatedKey')
        .mockRejectedValue(
          new StaticPageException(
  ...
  describe('validateUpdatedKey', () => {
    ...
    it('should throw an error if static page key already exist', async () => {
      ...
      await expect(
        service.validateUpdatedKey(staticPage, updateStaticPage),
      ).rejects.toThrow(StaticPageException);
    });
  });
  ...
  describe('remove', () => {
    ...
    it('should remove static page success', async () => {
      ...
      (staticPageRepositoryMock.remove as jest.Mock).mockResolvedValue(
        mockOutput,
      );
