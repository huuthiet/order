...
export default function OrderInformationAccordion({ orderDetailData, onSubmit }: { orderDetailData: IOrder, onSubmit: () => void }) {
    ...
    return (
        <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
                <AccordionTrigger onClick={handleSubmit} className="text-lg font-semibold">
