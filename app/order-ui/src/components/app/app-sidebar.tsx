  ...
  return (
    <SidebarProvider>
      <Sidebar variant="inset" className="border-r" collapsible="icon">
        <SidebarHeader>
          <SidebarMenu>
            <SidebarMenuItem className="">
              <SidebarMenuButton size="lg" asChild className="flex flex-row">
                <a href="#">
        ...
        <SidebarInset className="flex justify-end my-2">
          <header className="flex justify-end gap-2 children-center">
            <div className="flex items-center gap-2 px-4 children-center">
              <SidebarTrigger />
            </div>
          </header>
        </SidebarInset>
